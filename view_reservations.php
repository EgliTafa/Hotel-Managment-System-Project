...
<br/>
 ...
 <div class="col-md-6">
    <input type="text" name="search_text" id="search_text" placeholder="Search by Reservation Details" class="form-control" />
</div>
...
<div class="col-md-1">
    <a href="reserve.php" class="btn btn-success float-right"> Add Reservation </a>
</div>
